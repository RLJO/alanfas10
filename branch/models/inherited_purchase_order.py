...
class PurchaseOrder(models.Model):
    ...
    picking_type_id = fields.Many2one('stock.picking.type', 'Deliver To', states={'purchase': [('readonly', False)],'done': [('readonly', False)],'draft': [('readonly', False)]}, required=True, default=_default_picking_type, domain="['|', ('warehouse_id', '=', False), ('warehouse_id.company_id', '=', company_id)]",
